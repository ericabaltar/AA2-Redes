...
void UdpManager::ReceiveMovement(char* buffer, size_t dataRead, const sf::IpAddress & ip, unsigned short port) {
	MovementPacket movement;

	std::memcpy(&movement, buffer + dataRead, sizeof(MovementPacket));
